 ...
 */
public class ListSPFilesNodePlugin extends Plugin {
    // The shared instance.
    private static ListSPFilesNodePlugin plugin;

    /**
     * The constructor.
     */
    public ListSPFilesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ListSPFilesNodePlugin getDefault() {
        return plugin;
    }
