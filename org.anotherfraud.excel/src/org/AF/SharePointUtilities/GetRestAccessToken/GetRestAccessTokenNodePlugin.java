 ...
 * @author AnotherFraud
 */
public class GetRestAccessTokenNodePlugin extends Plugin {
    // The shared instance.
    private static GetRestAccessTokenNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetRestAccessTokenNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetRestAccessTokenNodePlugin getDefault() {
        return plugin;
    }
