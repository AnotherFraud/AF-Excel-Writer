package org.AF.SharePointUtilities.CreateSPFolder;
...
public class CreateSPFolderNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected CreateSPFolderNodeDialog() {
        ...
        proxyAuth = CreateSPFolderNodeModel.createProxySettingsModel();
        
       	clientTokenModel = CreateSPFolderNodeModel.createClientTokenSettingsModel();
       	final SettingsModelString useProxyModel = CreateSPFolderNodeModel.createUseProxySettingsModel();
       	final SettingsModelIntegerBounded proxyPort = CreateSPFolderNodeModel.createProxyPortIndexModel();
       	final SettingsModelString proxyHost = CreateSPFolderNodeModel.createProxyHostSettingsModel();
       	final SettingsModelString sharePointOnlineSiteURLModel = CreateSPFolderNodeModel.createSharePointUrlSettingsModel();
