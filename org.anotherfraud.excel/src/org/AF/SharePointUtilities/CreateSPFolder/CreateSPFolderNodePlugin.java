 ...
 */
public class CreateSPFolderNodePlugin extends Plugin {
    // The shared instance.
    private static CreateSPFolderNodePlugin plugin;

    /**
     * The constructor.
     */
    public CreateSPFolderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CreateSPFolderNodePlugin getDefault() {
        return plugin;
    }
