 ...
 * @author AnotherFraud
 */
public class GetSharePointRestConnectionNodePlugin extends Plugin {
    // The shared instance.
    private static GetSharePointRestConnectionNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetSharePointRestConnectionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetSharePointRestConnectionNodePlugin getDefault() {
        return plugin;
    }
