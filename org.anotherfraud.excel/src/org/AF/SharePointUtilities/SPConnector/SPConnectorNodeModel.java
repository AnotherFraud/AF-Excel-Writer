 ...
 * @author AnotherFraud
 */
public class SPConnectorNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(SPConnectorNodeModel.class);
	 ...
	 */
	protected SPConnectorNodeModel() {
		/**
