 ...
 */
public class SPConnectorNodePlugin extends Plugin {
    // The shared instance.
    private static SPConnectorNodePlugin plugin;

    /**
     * The constructor.
     */
    public SPConnectorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SPConnectorNodePlugin getDefault() {
        return plugin;
    }
