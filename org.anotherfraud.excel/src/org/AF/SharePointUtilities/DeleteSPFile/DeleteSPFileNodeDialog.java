...
public class DeleteSPFileNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected DeleteSPFileNodeDialog() {
        ...
        proxyAuth = DeleteSPFileNodeModel.createProxySettingsModel();
        
       	clientTokenModel = DeleteSPFileNodeModel.createClientTokenSettingsModel();
       	final SettingsModelString useProxyModel = DeleteSPFileNodeModel.createUseProxySettingsModel();
       	final SettingsModelIntegerBounded proxyPort = DeleteSPFileNodeModel.createProxyPortIndexModel();
       	final SettingsModelString proxyHost = DeleteSPFileNodeModel.createProxyHostSettingsModel();
       	final SettingsModelString sharePointOnlineSiteURLModel = DeleteSPFileNodeModel.createSharePointUrlSettingsModel();
