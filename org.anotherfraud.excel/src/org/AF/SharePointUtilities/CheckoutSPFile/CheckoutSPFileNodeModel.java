 ...
 */
public class CheckoutSPFileNodeModel extends NodeModel {
    

	private static final NodeLogger LOGGER = NodeLogger.getLogger(CheckoutSPFileNodeModel.class);
	 ...
	 */
	protected CheckoutSPFileNodeModel() {
		/**
