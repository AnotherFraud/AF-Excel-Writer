 ...
 */
public class MoveSPFileNodePlugin extends Plugin {
    // The shared instance.
    private static MoveSPFileNodePlugin plugin;

    /**
     * The constructor.
     */
    public MoveSPFileNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MoveSPFileNodePlugin getDefault() {
        return plugin;
    }
