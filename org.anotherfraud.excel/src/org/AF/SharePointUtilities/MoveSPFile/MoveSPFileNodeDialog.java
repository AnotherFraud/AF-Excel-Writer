package org.AF.SharePointUtilities.MoveSPFile;
...
public class MoveSPFileNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected MoveSPFileNodeDialog() {
        ...
        proxyAuth = MoveSPFileNodeModel.createProxySettingsModel();
        
       	clientTokenModel = MoveSPFileNodeModel.createClientTokenSettingsModel();
       	final SettingsModelString useProxyModel = MoveSPFileNodeModel.createUseProxySettingsModel();
       	final SettingsModelIntegerBounded proxyPort = MoveSPFileNodeModel.createProxyPortIndexModel();
       	final SettingsModelString proxyHost = MoveSPFileNodeModel.createProxyHostSettingsModel();
       	final SettingsModelString sharePointOnlineSiteURLModel = MoveSPFileNodeModel.createSharePointUrlSettingsModel();
        ...
        final SettingsModelBoolean copyFile = MoveSPFileNodeModel.createCopyFileSettingsModel();
       	...
       	{/**
			 * 
			 */
			private static final long serialVersionUID = -1689450617829381973L;

		{
       	...
       	{/**
			 * 
			 */
			private static final long serialVersionUID = -1253319828305601910L;
