...
public class MoveSPFileNodeModel extends NodeModel {
	...
	static SettingsModelString createSpFolderPathToSettingsModel() {
		SettingsModelString coof = new SettingsModelString(spFolderPathTo, "Shared%20Documents/<FolderName>/<FileName>");
		coof.setEnabled(true);
		return coof;				
	}	
	
	static SettingsModelString createSpFolderPathFromSettingsModel() {
		SettingsModelString coof = new SettingsModelString(spFolderPathFrom, "Shared%20Documents/<FolderName>/<FileName>");
		coof.setEnabled(true);
		return coof;				
	}	
