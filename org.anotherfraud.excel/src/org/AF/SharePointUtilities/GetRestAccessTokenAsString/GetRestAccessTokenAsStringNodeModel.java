 ...
 * @author AnotherFraud
 */
public class GetRestAccessTokenAsStringNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(GetRestAccessTokenAsStringNodeModel.class);
	 ...
	 */
	protected GetRestAccessTokenAsStringNodeModel() {
		/**
	...
	protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec)
	    ...
	    String url = "https://accounts.accesscontrol.windows.net/"
		    ...
		    if (accessToken != null)
		    {
				...
				pushFlowVariableString("SP_StrAccessToken", accessToken);
		    }
		    else
		    {
