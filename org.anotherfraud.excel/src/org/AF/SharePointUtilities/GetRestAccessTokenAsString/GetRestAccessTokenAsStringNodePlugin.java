 ...
 * @author AnotherFraud
 */
public class GetRestAccessTokenAsStringNodePlugin extends Plugin {
    // The shared instance.
    private static GetRestAccessTokenAsStringNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetRestAccessTokenAsStringNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetRestAccessTokenAsStringNodePlugin getDefault() {
        return plugin;
    }
