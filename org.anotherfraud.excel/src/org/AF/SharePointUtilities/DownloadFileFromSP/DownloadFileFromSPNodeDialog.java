...
public class DownloadFileFromSPNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected DownloadFileFromSPNodeDialog() {
        ...
        proxyAuth = DownloadFileFromSPNodeModel.createProxySettingsModel();
        
       	clientTokenModel = DownloadFileFromSPNodeModel.createClientTokenSettingsModel();
       	final SettingsModelString useProxyModel = DownloadFileFromSPNodeModel.createUseProxySettingsModel();
       	final SettingsModelIntegerBounded proxyPort = DownloadFileFromSPNodeModel.createProxyPortIndexModel();
       	final SettingsModelString proxyHost = DownloadFileFromSPNodeModel.createProxyHostSettingsModel();
       	final SettingsModelString sharePointOnlineSiteURLModel = DownloadFileFromSPNodeModel.createSharePointUrlSettingsModel();
