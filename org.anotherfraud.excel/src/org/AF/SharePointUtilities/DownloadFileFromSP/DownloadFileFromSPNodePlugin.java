 ...
 * @author 
 */
public class DownloadFileFromSPNodePlugin extends Plugin {
    // The shared instance.
    private static DownloadFileFromSPNodePlugin plugin;

    /**
     * The constructor.
     */
    public DownloadFileFromSPNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DownloadFileFromSPNodePlugin getDefault() {
        return plugin;
    }
