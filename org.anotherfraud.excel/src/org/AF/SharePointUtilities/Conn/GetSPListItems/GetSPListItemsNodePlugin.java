 ...
 */
public class GetSPListItemsNodePlugin extends Plugin {
    // The shared instance.
    private static GetSPListItemsNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetSPListItemsNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetSPListItemsNodePlugin getDefault() {
        return plugin;
    }
