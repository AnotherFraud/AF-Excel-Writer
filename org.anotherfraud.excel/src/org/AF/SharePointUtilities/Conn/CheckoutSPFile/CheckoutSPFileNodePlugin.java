 ...
 */
public class CheckoutSPFileNodePlugin extends Plugin {
    // The shared instance.
    private static CheckoutSPFileNodePlugin plugin;

    /**
     * The constructor.
     */
    public CheckoutSPFileNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CheckoutSPFileNodePlugin getDefault() {
        return plugin;
    }
