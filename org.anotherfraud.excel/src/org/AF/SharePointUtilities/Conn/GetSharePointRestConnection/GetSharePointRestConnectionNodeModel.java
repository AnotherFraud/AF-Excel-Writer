...
public class GetSharePointRestConnectionNodeModel extends NodeModel {
    ...
    static final ConnectionInformationPortObject createSPConnectionModel() {
    	ConnectionInformationPortObject newSPConn = new ConnectionInformationPortObject();
    	return newSPConn;
    }	
	...
	protected GetSharePointRestConnectionNodeModel() {
		...
		super(new PortType[]{FlowVariablePortObject.TYPE_OPTIONAL}, new PortType[]{ConnectionInformationPortObject.TYPE});
	...
	protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec)
	    ...
	    String url = "https://accounts.accesscontrol.windows.net/"
			...
			return new PortObject[]{new ConnectionInformationPortObject(createSpec(accessToken))};
	}
