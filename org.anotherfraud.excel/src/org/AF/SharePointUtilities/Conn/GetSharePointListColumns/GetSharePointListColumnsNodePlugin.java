 ...
 */
public class GetSharePointListColumnsNodePlugin extends Plugin {
    // The shared instance.
    private static GetSharePointListColumnsNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetSharePointListColumnsNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetSharePointListColumnsNodePlugin getDefault() {
        return plugin;
    }
