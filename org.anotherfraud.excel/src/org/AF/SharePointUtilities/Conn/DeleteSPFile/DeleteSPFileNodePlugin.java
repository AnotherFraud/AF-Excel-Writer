 ...
 */
public class DeleteSPFileNodePlugin extends Plugin {
    // The shared instance.
    private static DeleteSPFileNodePlugin plugin;

    /**
     * The constructor.
     */
    public DeleteSPFileNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DeleteSPFileNodePlugin getDefault() {
        return plugin;
    }
