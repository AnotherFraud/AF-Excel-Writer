 ...
 * @author AnotherFraud
 */
public class SPConnListFilesNodePlugin extends Plugin {
    // The shared instance.
    private static SPConnListFilesNodePlugin plugin;

    /**
     * The constructor.
     */
    public SPConnListFilesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SPConnListFilesNodePlugin getDefault() {
        return plugin;
    }
