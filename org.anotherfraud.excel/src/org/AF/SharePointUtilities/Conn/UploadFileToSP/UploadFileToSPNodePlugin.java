 ...
 */
public class UploadFileToSPNodePlugin extends Plugin {
    // The shared instance.
    private static UploadFileToSPNodePlugin plugin;

    /**
     * The constructor.
     */
    public UploadFileToSPNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static UploadFileToSPNodePlugin getDefault() {
        return plugin;
    }
