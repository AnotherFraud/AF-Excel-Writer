package org.AF.SharePointUtilities.DeleteSPFolder;
 ...
 */
public class DeleteSPFolderNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected DeleteSPFolderNodeDialog() {
        super();
        
        
        proxyAuth = DeleteSPFolderNodeModel.createProxySettingsModel();
        
       	clientTokenModel = DeleteSPFolderNodeModel.createClientTokenSettingsModel();
       	final SettingsModelString useProxyModel = DeleteSPFolderNodeModel.createUseProxySettingsModel();
       	final SettingsModelIntegerBounded proxyPort = DeleteSPFolderNodeModel.createProxyPortIndexModel();
       	final SettingsModelString proxyHost = DeleteSPFolderNodeModel.createProxyHostSettingsModel();
       	final SettingsModelString sharePointOnlineSiteURLModel = DeleteSPFolderNodeModel.createSharePointUrlSettingsModel();
        final SettingsModelString spFolderPathModel = DeleteSPFolderNodeModel.createSpFolderPathSettingsModel();
        final SettingsModelString sharePointNameModel = DeleteSPFolderNodeModel.createSharePointNameSettingsModel();
        final SettingsModelBoolean recycleBinModel = DeleteSPFolderNodeModel.createMoveToRecycleBinSettingsModel();
       	...
       	{/**
			 * 
			 */
			private static final long serialVersionUID = -6358199879714428173L;

		{
       	...
       	{/**
			 * 
			 */
			private static final long serialVersionUID = 1822570927020566918L;
        ...
        //listener check selection for password usage
       	...
       	addDialogComponent(new DialogComponentString(spFolderPathModel, "Delete Folder:  (complete path)", true, 60));
