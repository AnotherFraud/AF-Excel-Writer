 ...
 */
public class CheckinSPFileNodePlugin extends Plugin {
    // The shared instance.
    private static CheckinSPFileNodePlugin plugin;

    /**
     * The constructor.
     */
    public CheckinSPFileNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CheckinSPFileNodePlugin getDefault() {
        return plugin;
    }
