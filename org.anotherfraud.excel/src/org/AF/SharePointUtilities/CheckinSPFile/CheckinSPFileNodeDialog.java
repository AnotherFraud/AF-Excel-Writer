...
import org.AF.SharePointUtilities.CheckoutSPFile.CheckoutSPFileNodeModel;
import org.AF.SharePointUtilities.DeleteSPFile.DeleteSPFileNodeModel;
...
public class CheckinSPFileNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected CheckinSPFileNodeDialog() {
        ...
        proxyAuth = CheckinSPFileNodeModel.createProxySettingsModel();
       	clientTokenModel = CheckinSPFileNodeModel.createClientTokenSettingsModel();
       	final SettingsModelString useProxyModel = CheckinSPFileNodeModel.createUseProxySettingsModel();
       	final SettingsModelIntegerBounded proxyPort = CheckinSPFileNodeModel.createProxyPortIndexModel();
       	final SettingsModelString proxyHost = CheckinSPFileNodeModel.createProxyHostSettingsModel();
       	final SettingsModelString sharePointOnlineSiteURLModel = CheckinSPFileNodeModel.createSharePointUrlSettingsModel();
