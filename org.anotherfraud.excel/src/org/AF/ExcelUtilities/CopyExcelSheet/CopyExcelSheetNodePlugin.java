 ...
 */
public class CopyExcelSheetNodePlugin extends Plugin {
    // The shared instance.
    private static CopyExcelSheetNodePlugin plugin;

    /**
     * The constructor.
     */
    public CopyExcelSheetNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CopyExcelSheetNodePlugin getDefault() {
        return plugin;
    }
