 ...
 */
public class WriteToExcelTemplateV2NodePlugin extends Plugin {
    // The shared instance.
    private static WriteToExcelTemplateV2NodePlugin plugin;

    /**
     * The constructor.
     */
    public WriteToExcelTemplateV2NodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WriteToExcelTemplateV2NodePlugin getDefault() {
        return plugin;
    }
