 ...
 */
public class ExcelPasswordManagerNodePlugin extends Plugin {
    // The shared instance.
    private static ExcelPasswordManagerNodePlugin plugin;

    /**
     * The constructor.
     */
    public ExcelPasswordManagerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ExcelPasswordManagerNodePlugin getDefault() {
        return plugin;
    }
