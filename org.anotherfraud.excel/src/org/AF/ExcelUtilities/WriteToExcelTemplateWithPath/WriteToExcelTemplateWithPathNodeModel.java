...
public class WriteToExcelTemplateWithPathNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(WriteToExcelTemplateWithPathNodeModel.class);
	 ...
	 */
	protected WriteToExcelTemplateWithPathNodeModel(final PortsConfiguration portsConfig) {
		/**
