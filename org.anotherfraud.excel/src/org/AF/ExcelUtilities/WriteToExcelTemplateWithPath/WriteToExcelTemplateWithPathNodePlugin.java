 ...
 */
public class WriteToExcelTemplateWithPathNodePlugin extends Plugin {
    // The shared instance.
    private static WriteToExcelTemplateWithPathNodePlugin plugin;

    /**
     * The constructor.
     */
    public WriteToExcelTemplateWithPathNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WriteToExcelTemplateWithPathNodePlugin getDefault() {
        return plugin;
    }
