 ...
 */
public class WriteToExcelTemplateStreamingNodePlugin extends Plugin {
    // The shared instance.
    private static WriteToExcelTemplateStreamingNodePlugin plugin;

    /**
     * The constructor.
     */
    public WriteToExcelTemplateStreamingNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WriteToExcelTemplateStreamingNodePlugin getDefault() {
        return plugin;
    }
