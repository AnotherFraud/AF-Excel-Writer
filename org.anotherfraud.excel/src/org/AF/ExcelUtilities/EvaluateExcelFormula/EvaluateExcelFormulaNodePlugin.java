 ...
 */
public class EvaluateExcelFormulaNodePlugin extends Plugin {
    // The shared instance.
    private static EvaluateExcelFormulaNodePlugin plugin;

    /**
     * The constructor.
     */
    public EvaluateExcelFormulaNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EvaluateExcelFormulaNodePlugin getDefault() {
        return plugin;
    }
