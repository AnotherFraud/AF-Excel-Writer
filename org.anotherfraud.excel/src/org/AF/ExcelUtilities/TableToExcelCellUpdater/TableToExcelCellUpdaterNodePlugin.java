 ...
 */
public class TableToExcelCellUpdaterNodePlugin extends Plugin {
    // The shared instance.
    private static TableToExcelCellUpdaterNodePlugin plugin;

    /**
     * The constructor.
     */
    public TableToExcelCellUpdaterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TableToExcelCellUpdaterNodePlugin getDefault() {
        return plugin;
    }
