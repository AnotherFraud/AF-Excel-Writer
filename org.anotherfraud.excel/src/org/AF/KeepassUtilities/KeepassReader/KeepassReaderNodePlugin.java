 ...
 */
public class KeepassReaderNodePlugin extends Plugin {
    // The shared instance.
    private static KeepassReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public KeepassReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static KeepassReaderNodePlugin getDefault() {
        return plugin;
    }
