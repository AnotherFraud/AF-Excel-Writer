 ...
 */
public class ExecuteShellScriptNodePlugin extends Plugin {
    // The shared instance.
    private static ExecuteShellScriptNodePlugin plugin;

    /**
     * The constructor.
     */
    public ExecuteShellScriptNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ExecuteShellScriptNodePlugin getDefault() {
        return plugin;
    }
