 ...
 * @author AnotherFraud
 */
public class TableEditWithSelectionNodePlugin extends Plugin {
    // The shared instance.
    private static TableEditWithSelectionNodePlugin plugin;

    /**
     * The constructor.
     */
    public TableEditWithSelectionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TableEditWithSelectionNodePlugin getDefault() {
        return plugin;
    }
