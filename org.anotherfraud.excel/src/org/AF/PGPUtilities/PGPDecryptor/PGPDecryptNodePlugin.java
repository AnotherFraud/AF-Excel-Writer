 ...
 * @author 
 */
public class PGPDecryptNodePlugin extends Plugin {
    // The shared instance.
    private static PGPDecryptNodePlugin plugin;

    /**
     * The constructor.
     */
    public PGPDecryptNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PGPDecryptNodePlugin getDefault() {
        return plugin;
    }
