 ...
 */
public class HmacHashingNodePlugin extends Plugin {
    // The shared instance.
    private static HmacHashingNodePlugin plugin;

    /**
     * The constructor.
     */
    public HmacHashingNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static HmacHashingNodePlugin getDefault() {
        return plugin;
    }
