 ...
 */
public class PGPEncryptorNodePlugin extends Plugin {
    // The shared instance.
    private static PGPEncryptorNodePlugin plugin;

    /**
     * The constructor.
     */
    public PGPEncryptorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PGPEncryptorNodePlugin getDefault() {
        return plugin;
    }
