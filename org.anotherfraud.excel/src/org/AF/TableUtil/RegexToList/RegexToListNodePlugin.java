 ...
 */
public class RegexToListNodePlugin extends Plugin {
    // The shared instance.
    private static RegexToListNodePlugin plugin;

    /**
     * The constructor.
     */
    public RegexToListNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RegexToListNodePlugin getDefault() {
        return plugin;
    }
