 ...
 */
public class GroupAllNodePlugin extends Plugin {
    // The shared instance.
    private static GroupAllNodePlugin plugin;

    /**
     * The constructor.
     */
    public GroupAllNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GroupAllNodePlugin getDefault() {
        return plugin;
    }
