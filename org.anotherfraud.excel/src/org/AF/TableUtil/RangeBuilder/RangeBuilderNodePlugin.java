 ...
 * @author AnotherFraud
 */
public class RangeBuilderNodePlugin extends Plugin {
    // The shared instance.
    private static RangeBuilderNodePlugin plugin;

    /**
     * The constructor.
     */
    public RangeBuilderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RangeBuilderNodePlugin getDefault() {
        return plugin;
    }
