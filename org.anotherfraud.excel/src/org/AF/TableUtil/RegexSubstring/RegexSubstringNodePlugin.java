 ...
 */
public class RegexSubstringNodePlugin extends Plugin {
    // The shared instance.
    private static RegexSubstringNodePlugin plugin;

    /**
     * The constructor.
     */
    public RegexSubstringNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RegexSubstringNodePlugin getDefault() {
        return plugin;
    }
