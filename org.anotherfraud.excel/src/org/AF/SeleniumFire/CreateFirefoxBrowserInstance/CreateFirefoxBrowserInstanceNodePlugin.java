 ...
 */
public class CreateFirefoxBrowserInstanceNodePlugin extends Plugin {
    // The shared instance.
    private static CreateFirefoxBrowserInstanceNodePlugin plugin;

    /**
     * The constructor.
     */
    public CreateFirefoxBrowserInstanceNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CreateFirefoxBrowserInstanceNodePlugin getDefault() {
        return plugin;
    }
