 ...
 */
public class ScreenshotNodePlugin extends Plugin {
    // The shared instance.
    private static ScreenshotNodePlugin plugin;

    /**
     * The constructor.
     */
    public ScreenshotNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ScreenshotNodePlugin getDefault() {
        return plugin;
    }
