 ...
 */
public class SendSpecialKeysNodePlugin extends Plugin {
    // The shared instance.
    private static SendSpecialKeysNodePlugin plugin;

    /**
     * The constructor.
     */
    public SendSpecialKeysNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SendSpecialKeysNodePlugin getDefault() {
        return plugin;
    }
