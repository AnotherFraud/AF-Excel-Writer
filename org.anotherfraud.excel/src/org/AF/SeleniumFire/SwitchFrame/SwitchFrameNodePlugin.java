 ...
 */
public class SwitchFrameNodePlugin extends Plugin {
    // The shared instance.
    private static SwitchFrameNodePlugin plugin;

    /**
     * The constructor.
     */
    public SwitchFrameNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SwitchFrameNodePlugin getDefault() {
        return plugin;
    }
