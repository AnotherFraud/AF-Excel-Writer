 ...
 */
public class OptionPickerNodePlugin extends Plugin {
    // The shared instance.
    private static OptionPickerNodePlugin plugin;

    /**
     * The constructor.
     */
    public OptionPickerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static OptionPickerNodePlugin getDefault() {
        return plugin;
    }
