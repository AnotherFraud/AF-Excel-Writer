 ...
 */
public class FindWebElementNodePlugin extends Plugin {
    // The shared instance.
    private static FindWebElementNodePlugin plugin;

    /**
     * The constructor.
     */
    public FindWebElementNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FindWebElementNodePlugin getDefault() {
        return plugin;
    }
