 ...
 */
public class WaitForWebElementNodePlugin extends Plugin {
    // The shared instance.
    private static WaitForWebElementNodePlugin plugin;

    /**
     * The constructor.
     */
    public WaitForWebElementNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WaitForWebElementNodePlugin getDefault() {
        return plugin;
    }
