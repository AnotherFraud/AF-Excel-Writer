 ...
 */
public class ClearNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(ClearNodeModel.class);
	...
	protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec)
		 ...
		 * log.
		 */
		LOGGER.info("Start executing click webElement");
