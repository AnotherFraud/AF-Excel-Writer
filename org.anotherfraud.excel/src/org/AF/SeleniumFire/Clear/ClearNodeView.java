 ...
 */
public class ClearNodeView extends NodeView<ClearNodeModel> {

    /**
     * Creates a new view.
     * 
     * @param nodeModel The model (class: {@link ClearNodeModel})
     */
    protected ClearNodeView(final ClearNodeModel nodeModel) {
        super(nodeModel);
    ...
    protected void modelChanged() {
        ...
        // update the view.
        ClearNodeModel nodeModel = 
            (ClearNodeModel)getNodeModel();
