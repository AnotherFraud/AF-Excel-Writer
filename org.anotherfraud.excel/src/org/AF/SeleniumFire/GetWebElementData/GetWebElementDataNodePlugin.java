 ...
 */
public class GetWebElementDataNodePlugin extends Plugin {
    // The shared instance.
    private static GetWebElementDataNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetWebElementDataNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetWebElementDataNodePlugin getDefault() {
        return plugin;
    }
