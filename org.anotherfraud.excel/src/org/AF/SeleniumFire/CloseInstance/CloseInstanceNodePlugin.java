 ...
 */
public class CloseInstanceNodePlugin extends Plugin {
    // The shared instance.
    private static CloseInstanceNodePlugin plugin;

    /**
     * The constructor.
     */
    public CloseInstanceNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CloseInstanceNodePlugin getDefault() {
        return plugin;
    }
