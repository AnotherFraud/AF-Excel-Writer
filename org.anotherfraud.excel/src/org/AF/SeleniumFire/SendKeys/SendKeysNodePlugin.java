 ...
 */
public class SendKeysNodePlugin extends Plugin {
    // The shared instance.
    private static SendKeysNodePlugin plugin;

    /**
     * The constructor.
     */
    public SendKeysNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SendKeysNodePlugin getDefault() {
        return plugin;
    }
