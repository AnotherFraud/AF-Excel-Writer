 ...
 */
public class SwitchTabNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(SwitchTabNodeModel.class);

    static final String tabNumber = "tabNumber";

	
	static SettingsModelIntegerBounded createTabNumberSettingsModel() {
		SettingsModelIntegerBounded roff = new SettingsModelIntegerBounded(tabNumber, 1, 1, 1048575);
		return roff;				
	}	
	
	
	private final SettingsModelIntegerBounded m_tabNumber = createTabNumberSettingsModel();

    
	/**
	 * Constructor for the node model.
	 */
	protected SwitchTabNodeModel() {
	...
	protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec)
		...
		driver.switchTo().window(allTabs.get(m_tabNumber.getIntValue()));
	...
	protected void saveSettingsTo(final NodeSettingsWO settings) {
		...
		m_tabNumber.saveSettingsTo(settings);
	...
	protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		m_tabNumber.loadSettingsFrom(settings);
	...
	protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		 ...
		 * variables.
		 */
		m_tabNumber.validateSettings(settings);
