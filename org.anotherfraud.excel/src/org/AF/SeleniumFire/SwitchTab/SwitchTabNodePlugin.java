 ...
 */
public class SwitchTabNodePlugin extends Plugin {
    // The shared instance.
    private static SwitchTabNodePlugin plugin;

    /**
     * The constructor.
     */
    public SwitchTabNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SwitchTabNodePlugin getDefault() {
        return plugin;
    }
