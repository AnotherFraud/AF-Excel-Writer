 ...
 * @author 
 */
public class GetSessionDataNodePlugin extends Plugin {
    // The shared instance.
    private static GetSessionDataNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetSessionDataNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetSessionDataNodePlugin getDefault() {
        return plugin;
    }
