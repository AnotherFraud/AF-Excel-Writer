 ...
 */
public class ExecuteJavaScriptNodePlugin extends Plugin {
    // The shared instance.
    private static ExecuteJavaScriptNodePlugin plugin;

    /**
     * The constructor.
     */
    public ExecuteJavaScriptNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ExecuteJavaScriptNodePlugin getDefault() {
        return plugin;
    }
