 ...
 */
public class ExecuteJavaScriptNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(ExecuteJavaScriptNodeModel.class);

    static final String JavaScript = "javaScript";


    	
	static SettingsModelString createJavaScriptStringSettingsModel() {
		SettingsModelString coof = new SettingsModelString(JavaScript, null);
		coof.setEnabled(true);
		return coof;				
	}	

    
	private final SettingsModelString m_javaScript = createJavaScriptStringSettingsModel();
	 ...
	 */
	protected ExecuteJavaScriptNodeModel() {
	...
	protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec)
		 ...
		 * log.
		 */
		LOGGER.info("Start executing ExecuteJavaScript");
		...
		String javaScript = m_javaScript.getStringValue();
	...
	protected void saveSettingsTo(final NodeSettingsWO settings) {
		 ...
		 */
		m_javaScript.saveSettingsTo(settings);
	...
	protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
		 ...
		 */
		m_javaScript.loadSettingsFrom(settings);
	...
	protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		 ...
		 * variables.
		 */
		m_javaScript.validateSettings(settings);
