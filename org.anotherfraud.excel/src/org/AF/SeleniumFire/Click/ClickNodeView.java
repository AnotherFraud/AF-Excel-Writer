 ...
 */
public class ClickNodeView extends NodeView<ClickNodeModel> {

    /**
     * Creates a new view.
     * 
     * @param nodeModel The model (class: {@link ClickNodeModel})
     */
    protected ClickNodeView(final ClickNodeModel nodeModel) {
        super(nodeModel);
    ...
    protected void modelChanged() {
        ...
        // update the view.
        ClickNodeModel nodeModel = 
            (ClickNodeModel)getNodeModel();
